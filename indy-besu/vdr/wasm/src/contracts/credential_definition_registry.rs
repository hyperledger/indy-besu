use indy2_vdr::{credential_definition_registry, Address, CredentialDefinition, CredentialDefinitionId};
...
impl CredentialDefinitionRegistry {
    ...
    pub async fn build_create_credential_definition_transaction(client: &LedgerClientWrapper,
        ...
        let transaction = credential_definition_registry::build_create_credential_definition_transaction(&client.0, &address, &cred_def).await.as_js()?;
    ...
    pub async fn build_resolve_credential_definition_transaction(client: &LedgerClientWrapper,
        ...
        let transaction = credential_definition_registry::build_resolve_credential_definition_transaction(&client.0, &id).await.as_js()?;
        Ok(TransactionWrapper(transaction))
    }
    ...
    pub fn parse_resolve_credential_definition_result(client: &LedgerClientWrapper,
        ...
        let cred_def = credential_definition_registry::parse_resolve_credential_definition_result(&client.0, bytes).as_js()?;
